...
//hbm.Game.GUI.Trade.InventoryTradeItem
...
package hbm.Game.GUI.Trade
{
    ...
    public class InventoryTradeItem extends InventoryItem 
    {

        private var _clickable:Boolean = true;

        public function InventoryTradeItem(_arg_1:ItemData, _arg_2:Boolean=true)
        {
