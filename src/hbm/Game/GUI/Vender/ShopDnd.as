...
package hbm.Game.GUI.Vender
{
    ...
    public class ShopDnd implements DragListener 
    {
        ...
        {
            var _local_2:ShopItemPanel = ShopItemPanel(_arg_1);
            ClientApplication.Instance.LocalGameClient.SendVenderBuy(_local_2.ShopItem.Item.Id, 1);
        }
