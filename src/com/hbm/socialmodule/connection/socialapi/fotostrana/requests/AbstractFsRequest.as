...
//com.hbm.socialmodule.connection.socialapi.fotostrana.requests.AbstractFsRequest
...
package com.hbm.socialmodule.connection.socialapi.fotostrana.requests
{
    ...
    public class AbstractFsRequest extends EventDispatcher 
    {

        private static const logger:ILogger = getLogger(AbstractFsRequest);
        public static const FINISHED:String = "fs_request_done";
        public static const MESSAGE_ERROR:String = "fs_request_error";
        public static const CONNECTION_ERROR:String = "fs_connection_error";
        ...
        public function SendRequest():void
        {
            ...
            logger.debug(("to fs: " + _local_1.data));
        ...
        private function CheckAndFormatAnswerData(_arg_1:Object):void
        {
            ...
            else
            {
                ...
                {
                    logger.error(((((("Error " + _arg_1.error.error_code) + " (") + _arg_1.error.error_subcode) + "): ") + _arg_1.error.error_msg));
        ...
        protected function FinishRequest(_arg_1:Object):void
        {
            ...
            dispatchEvent(new Event(AbstractFsRequest.FINISHED));
        }
